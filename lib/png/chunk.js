...
Chunk.addChunkType = function (type, module) {
	...
	// Make it compatible with browserify
	var m = require('./utils/chunkUtils.js');
	utils.loadModule(m, module);
...
Chunk.initDefaultChunkTypes = function () {
	...
	// Make it compatible with browserify
	this.addChunkType('bKGD', require('./chunks/bKGD.js'));
	this.addChunkType('cHRM', require('./chunks/cHRM.js'));
	this.addChunkType('gAMA', require('./chunks/gAMA.js'));
	this.addChunkType('hIST', require('./chunks/hIST.js'));
	this.addChunkType('iCCP', require('./chunks/iCCP.js'));
	this.addChunkType('IDAT', require('./chunks/IDAT.js'));
	this.addChunkType('IEND', require('./chunks/IEND.js'));
	this.addChunkType('IHDR', require('./chunks/IHDR.js'));
	this.addChunkType('pHYs', require('./chunks/pHYs.js'));
	this.addChunkType('PLTE', require('./chunks/PLTE.js'));
	this.addChunkType('sRGB', require('./chunks/sRGB.js'));
	this.addChunkType('tEXt', require('./chunks/tEXt.js'));
	this.addChunkType('tIME', require('./chunks/tIME.js'));
	this.addChunkType('tRNS', require('./chunks/tRNS.js'));
	this.addChunkType('zTXt', require('./chunks/zTXt.js'));
	this.addChunkType('oFFs', require('./chunks/zTXt.js'));
	this.addChunkType('sCAL', require('./chunks/zTXt.js'));
	this.addChunkType('sTER', require('./chunks/zTXt.js'));
...
Chunk.initCustomChunkTypes = function () {
	...
	// Make it compatible with browserify
	this.addChunkType('stRT', require('./custom/stRT.js'));
	this.addChunkType('jsOn', require('./custom/jsOn.js'));
	this.addChunkType('zzZz', require('./custom/zzZz.js'));
